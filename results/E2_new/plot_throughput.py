#!/usr/bin/env python3
"""Plot throughput by batch size for E2_new runs.

Input:
  results/E2_new/e2_runs.csv

Output:
  results/E2_new/plots/06_throughput_distinct.png
"""
...
def main():
    ...
    ax.set_title("E2_new Throughput by Batch Size", fontsize=14, fontweight="bold")
    ax.set_xticks(x)
